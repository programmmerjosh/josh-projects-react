...
const myProjects = [
  {
    ...
    title: "Goal Symmetry",
    description:
      "Josh wanted to create the ultimate goal setting, self-studying, personal development blueprint tool. So, here it is! He's also got some exciting updates already lined up for 2022. Available on App Store AND Play Store.",
  ...
  },
  {
    ...
    description:
      "Business website of a mobile application development limited company. Josh actually started this company himself in October 2021.",
  ...
  },
  {
    ...
    title: "Résumé",
    description:
      "Résumé/portfolio website built for and by myself. Every developer needs a portfolio to showcase and demonstrate some skills and previous projects, so here you go.",
    imageUrl: resume,
  ...
  },
  {
    ...
    description:
      "When you've got or you've discovered something important to share with the world, you should share it. This website was built specifically for the purpose of sharing factual and/or experiential information however controversial some of it may be. Check it out.",
    imageUrl: truth,
  ...
  },
  {
    ...
    description:
      "If you saw Goal Symmetry, Ready Set Goals is where it all started. This was Josh's first goal setting app. It's not quite as nifty and feature full as Goal Symmetry, but it works. Available on the App Store.",
  ...
  },
  {
    ...
    description:
      "Socks - Bill Assigning Tool is exactly what it sounds like. It's an application that simplifies the process of assigning the amounts each person needs to contribute towards the restaurant check/bill. Available on the App Store.",
    imageUrl: socks,
    gitHubUrl:
      "https://github.com/programmmerjosh/sock-bill-assigning-tool-public",
    directLinkUrl:
  ...
  },
  {
    ...
    description:
      "A static webpage (HTML, CSS, JS & Bootstrap) converted into a dynamic WordPress site.",
  ...
  },
  {
    ...
    title: "Norris 25",
    description:
      "Norris 25 was one of Josh's very first apps. Norris 25 is a survey/questionaire type app. It serves the user with several questions on a particular topic and the then calculates the user's score based on their answers. Available on the App Store.",
    imageUrl: norris25,
  ...
  },
  {
    ...
    title: "LoopLab",
    description:
      "This is a Bootstrap Theme - followed & coded along with the course.",
    imageUrl: looplab,
  ...
  },
  {
    ...
    gitHubUrl:
      "https://github.com/programmmerjosh/Portfoligrid-Bootstrap-theme",
    directLinkUrl:
      "https://www.udemy.com/course/bootstrap-4-from-scratch-with-5-projects/",
    iconSvgs: [html, css, jquery, bootstrap],
  },
  {
    ...
    title: "Twittermenti",
    description:
      "This app produces a response based on twitter responses from real people. Machine Learning technology.",
  ...
  },
  {
    ...
    title: "Seefood",
    description:
      "Take a photo and the app will tell you if the main object in the picture is a hotdog or not. Machine Learning technology. This app was cloned from an episode of the popular series, Silicon Valley.",
    imageUrl: seefood,
  ...
  },
  {
    ...
    title: "Clima Clone",
    description:
      "A cloned version of a weather app called Clima. Uses the weather-map api.",
    imageUrl: clima,
  ...
  },
  {
    ...
    title: "Finance",
    description:
      "CS50 Problem Set 7: A mock website that allows you to buy fake amounts of stocks and shares using fake money.",
    imageUrl: finance,
  ...
  },
  {
    ...
    description:
      "Add meetup locations to firebase DB, fetch those locations and display favorites.",
  ...
  },
  {
    ...
    description:
      "Simple tutorial I found I YouTube on how to add Bootstrap to a React App",
  ...
  },
  {
    ...
    description:
      "SPA that a user can interact with by clicking on buttons OR pressing specific keyboard keys to produce a particular drum sound",
    imageUrl: drumKit,
