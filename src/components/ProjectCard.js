...
function ProjectCard(props) {
  ...
  return (
    <div className="proj-card">
      <Card>
        {/* title */}
        <h6 style={projectColor} key={props.id}>
          {props.title}
        </h6>
        ...
        <Row>
          <Col>
            ...
            {
              <img
                className="d-block project-img mx-auto mb-3"
                src={props.imageUrl}
                alt="project preview"
              />
            }
          ...
          <Col>
            <Row className="align-items-center">
              {/* type */}
              <p className="project-note" style={projectColor}>
                {projectEmoji} {props.source} Project {projectEmoji}
              </p>
              {/* description */}
        ...
        <Row>
          ...
          <Col>
            {icons.map((svg) =>
              icons.length > 0 ? (
                <FaIcon key={props.title + svg} svg={svg} alt="icon" />
              ) : (
                <div />
              )
            )}
